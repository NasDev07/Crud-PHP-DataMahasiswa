	...
	<div class="container col-md-6 mt-4">
		...
		<div class="card">
			...
			<div class="card-body">
				...
				$data = mysqli_query($koneksi, "select * from tb_crud where id = '$id'");
				...
				<form action="" method="post" role="form">
					...
					<div class="form-group">
						<label>Jurusan</label>
						<!--  <input type="text" class="form-control" name="deskripsi"><?= $row['deskripsi']; ?>  -->
						<select class="form-control" name="deskripsi" placeholder="Pilih Jurusan" required> <?= $row['deskripsi']; ?>
				...
				if (isset($_POST['submit'])) {
					...
					$query = mysqli_query($koneksi, "update tb_crud set nama='$nama', harga='$harga', deskripsi='$deskripsi' where id='$id'");
